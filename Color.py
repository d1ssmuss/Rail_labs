...
class DraggableArcs:
    def __init__(self, canvas):
        ...
        self.arcs.append(canvas.create_arc((50, 50), (600, 600), width=2, fill="blue",
                                           start=0, extent=20))
        self.arcs.append(canvas.create_arc((102, 355), (550, 800), width=2, fill="red",
                                           start=0, extent=60))
        ...
        for arc in self.arcs:
            ...
            self.canvas.tag_bind(arc, "<ButtonRelease-1>", self.on_button_release)
    ...
    def open_file(self):
        # Функция с помощью которой можно открывать файл
        pass
    ...
    def show_information_about_program(self):
        ...
        label = tk.Label(window, text="--Руководство к приложению--\n"
                                      ...
                                      "   - Первый объект (4 числа): координаты прямоугольника, который задаёт сектор круга: x0, y0, x1, y1\n"
